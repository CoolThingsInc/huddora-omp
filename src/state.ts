...
export function parseState(data: unknown): HuddoraPluginState | null {
	...
	return {
		...
		bridgeDisabled: typeof d.bridgeDisabled === "boolean" ? d.bridgeDisabled : false,
		bridgeDisclosureSeen: typeof d.bridgeDisclosureSeen === "boolean" ? d.bridgeDisclosureSeen : false,
		projectRoot: asNullableString(d.projectRoot) ?? base.projectRoot,
		guidanceProjectKey: asNullableString(d.guidanceProjectKey) ?? base.guidanceProjectKey,
		...
		sessionKey: asNullableString(d.sessionKey) ?? base.sessionKey,
		agentDisplayName: asNullableString(d.agentDisplayName) ?? base.agentDisplayName,
		lastExtensionVersion: asNullableString(d.lastExtensionVersion) ?? base.lastExtensionVersion,
...
export function toDurable(state: HuddoraPluginState): HuddoraPluginState {
	return {
		...
		bridgeDisclosureSeen: state.bridgeDisclosureSeen,
		projectRoot: state.projectRoot,
		guidanceProjectKey: state.guidanceProjectKey,
